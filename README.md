...

{
 ...
 && time.minutes ==alarm.minutes && time.seconds == alarm.seconds)
...
Time alarmTime = {0, 0, 10}; // Example alarm time at 06:30:00
...
time->seconds++;
 ...
 if (time->seconds >= 60)
   ...
   if (time->hours == lastHour && time->minutes == 0 && time->seconds == 0)
    {
   time->hours++;
